...
class PalTranslations {
    ...
    public static Result load(Logger logger) {
        ...
        var langLoader = new UrlLanguageLoader(locations, List.of("assets/" + PalMod.ID + "/lang/"), logger);
